...
def clean_segment(segment, client=None):
    """
    Translate this text into english using.
    ...
    try:
        ...
        instruction = """
Please provide a translation to this text into english, and don't respond with any text after the translation:
...
"""
        ...
        # Print it again without any logging prefixes to ensure it's captured
        print(f"OpenAI API response: {assistant_reply}")

...
def setup_logging():
    ...
    logging.basicConfig(
        filename='/home/j/Desktop/Finals/temp12341234.log',
        filemode='w',
        level=logging.INFO,
...
def clean_segment(segment, window=None):
    ...
    try:
        ...
        instructions = (
            "Create a concise and cohesive update from multiple seemingly unrelated tweets that are actually about the same single event. "
            ...
            "8) Use 3 to 6 hashtags at the top so the reader can get a feel for what the story is about upfront."
            ...
            "\n\nPlease apply all the above guidelines to rewrite the following content:\n\n"
        )
